class ImagesController < ApplicationController
  ...
  def create
    ...
    if @image.save
      redirect_to redirect_path, notice: 'Image was successfully saved.'
    else
      render :new
    end
  end
  ...
  def update
    if @image.update(image_params)
      redirect_to redirect_path, notice: 'Image was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    @image.destroy
    redirect_to redirect_path, notice: 'Image was successfully removed.'
  end
